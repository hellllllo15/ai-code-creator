...
export async function adminList(body: API.AppQueryRequest, options?: { [key: string]: any }) {
...
export async function getMyById(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getMyByIdParams,
  options?: { [key: string]: any }
) {
...
/** 此处后端没有提供注释 POST /app/list/page/hot */
export async function listHot(body: API.AppQueryRequest, options?: { [key: string]: any }) {
  return request<API.BaseResponsePageAppVO>('/app/list/page/hot', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listMy(body: API.AppQueryRequest, options?: { [key: string]: any }) {
...
export async function updateMy(body: API.AppUpdateMyRequest, options?: { [key: string]: any }) {
